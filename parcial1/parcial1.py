...
def listado_por_nombre_real(lista):
    copia = List(lista[:])
    copia.add_criterion("real_name", get_real_name)  
    copia.sort_by_criterion("real_name")
    copia.show()

def listado_por_fecha_aparicion(lista):
    copia = List(lista[:])
    copia.add_criterion("first_appearance", get_first_appearance)
    copia.sort_by_criterion("first_appearance")
    copia.show()
